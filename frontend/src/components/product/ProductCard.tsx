    ...
    <div className="group cursor-pointer">
      ...
      <div className="px-3 pt-3">
        ...
        <div className="flex items-center gap-1.5">
          {salePrice ? (
            <>
              <span className="text-[13px] font-semibold text-[#111]">{salePrice.toLocaleString()}원</span>
              <span className="text-[11px] text-[#B8B4AE] line-through">{price.toLocaleString()}원</span>
            </>
          ) : (
            <span className="text-[13px] font-semibold text-[#111]">{price.toLocaleString()}원</span>
          )}
        </div>
        <div className="flex items-center gap-1 mt-1.5">
          <svg className="w-2.5 h-2.5 text-[#1F3D2A]" fill="currentColor" viewBox="0 0 20 20">
